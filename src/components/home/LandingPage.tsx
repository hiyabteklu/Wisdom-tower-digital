            ...
            >
              ...
              >
                ...
                <div className="relative z-10 px-6 py-10 sm:py-12 md:py-14 min-h-[12.5rem] md:min-h-[14rem] flex flex-col items-center justify-center">
                  ...
                  <div
                    className="text-xs sm:text-sm text-white/90 font-semibold uppercase tracking-[0.18em]"
...
export default function LandingPage() {
  ...
  const reduced = usePrefersReducedMotion();
  const pathSection = useInView<HTMLElement>({ threshold: 0.12 });
  const statsSection = useInView<HTMLElement>({ threshold: 0.15 });
  const crossSection = useInView<HTMLElement>({ threshold: 0.2 });
  ...
  return (
    <div className="landing-depth">
      <section ref={heroRef} className="relative overflow-hidden hero-scene">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-wisdom-cyan/[0.05] via-transparent to-transparent z-[1]" />
        ...
        />
        <div
          className="absolute bottom-8 right-[10%] w-72 h-72 bg-emerald-500/14 rounded-full blur-3xl pointer-events-none orb-float-delayed z-[1]"
          style={blob2}
        />
        ...
        >
          ...
          <div className="hero-cta flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/services"
              className="inline-flex items-center justify-center gap-2 min-h-[3.25rem] px-8 py-3.5 rounded-2xl bg-wisdom-cyan text-wisdom-dark text-base font-bold
                hover:opacity-90 active:scale-[0.98] transition-all duration-300 shadow-lg shadow-cyan-500/25"
            >
              Browse services
            ...
            <Link
              href="/request"
              className="inline-flex items-center justify-center gap-2 min-h-[3.25rem] px-8 py-3.5 rounded-2xl border-2 border-wisdom-cyan/50 text-white text-base font-bold
                bg-wisdom-card hover:bg-wisdom-cyan/15 active:scale-[0.98] transition-all duration-300"
            >
              Request a project
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6 items-stretch">
            ...
            <div className="lg:col-span-1 flex">
              <InfinityCard visible={statsSection.inView} delay={200} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pb-28 relative" ref={ctaSection.ref}>
        ...
        >
          <div className="cta-panel rounded-3xl border border-white/12 bg-wisdom-card/80 backdrop-blur-md px-6 py-10 md:px-12 md:py-12 card-elevated">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 min-h-[3.25rem] px-9 py-4 rounded-2xl bg-wisdom-cyan text-wisdom-dark font-bold text-lg
